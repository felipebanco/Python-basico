#Diccionarios
'''tipo de colección donde los elementos tambien se guardan desordenados con 2 elementos por posicion la clave y el valor. No pueden haber claves duplicadas.'''
